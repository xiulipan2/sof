...
define(DEF_TDFB_ENUM1, concat(`tdfb_enum1_', PIPELINE_ID))
define(DEF_TDFB_ENUM2, concat(`tdfb_enum2_', PIPELINE_ID))
...
# TDFB enum control
C_CONTROLENUM(DEF_TDFB_ENUM1, PIPELINE_ID,
	DEF_TDFB_ONOFF,
...
# TDFB enum list
CONTROLENUM_LIST(DEF_TDFB_BEAMN, LIST(`	', `"0deg"', `"10deg"', `"20deg"', `"30deg"'))

# TDFB enum control
C_CONTROLENUM(DEF_TDFB_ENUM2, PIPELINE_ID,
	DEF_TDFB_BEAMN,
	LIST(`	', ENUM_CHANNEL(FC, 3, 0)),
	CONTROLENUM_OPS(enum,
		257 binds the mixer control to enum get/put handlers,
...
undefine(`DEF_TDFB_ENUM1')
undefine(`DEF_TDFB_ENUM2')
